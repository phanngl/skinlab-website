...
export function TreatmentCard({ service }: { service: Service }) {
  ...
  return (
    <div className="flex h-full flex-col rounded-4xl border border-ink/5 bg-surface p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-md dark:border-white/10">
      ...
      <div className="mt-6 flex items-center justify-between border-t border-ink/5 pt-4 text-sm dark:border-white/10">
